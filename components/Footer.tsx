      ...
      <div className="relative z-10 container mx-auto px-4">
          ...
          <div className="grid w-full grid-cols-2 gap-5 gap-y-10 md:flex md:justify-between lg:gap-8 xl:w-auto xl:justify-center 2xl:gap-14">
            <div className="space-y-3.5 sm:space-y-5 lg:space-y-6 2xl:min-w-33.5">
              ...
              <div className="flex flex-col items-start gap-2 sm:gap-3 lg:gap-4">
                ...
                <Link href="/blog" className="footer-links">Blog</Link>
                <Link href="/faqs" className="footer-links">FAQs</Link>
                <Link href="/profile" className="footer-links">My profile</Link>
              </div>
            </div>

            <div className="space-y-3.5 sm:space-y-5 lg:space-y-6 2xl:min-w-33.5">
              <h2 className="text-xl">Popular Routes</h2>
              <div className="flex flex-col items-start gap-2 sm:gap-3 lg:gap-4">
                <Link href="/routes/addis-bahirdar" className="footer-links">Addis Ababa - Bahir Dar</Link>
                <Link href="/routes/addis-gondar" className="footer-links">Addis Ababa - Gondar</Link>
                <Link href="/routes/addis-axum" className="footer-links">Addis Ababa - Axum</Link>
                <Link href="/routes/addis-jimma" className="footer-links">Addis Ababa - Jimma</Link>
                <Link href="/routes/bahirdar-gondar" className="footer-links">Bahir Dar - Gondar</Link>
              </div>
            </div>
            ...
            <div className="space-y-3.5 sm:space-y-5 lg:space-y-6">
              ...
              <div className="flex flex-col items-start gap-2 sm:gap-3 lg:gap-4">
                <Link href="/destinations/addis-ababa" className="footer-links">Addis Ababa</Link>
                <Link href="/destinations/bahir-dar" className="footer-links">Bahir Dar</Link>
                <Link href="/destinations/gondar" className="footer-links">Gondar</Link>
                <Link href="/destinations/axum" className="footer-links">Axum</Link>
                <Link href="/destinations/jimma" className="footer-links">Jimma</Link>
                <Link href="/destinations/hawassa" className="footer-links">Hawassa</Link>
              </div>
            </div>
            ...
            <div className="space-y-3.5 sm:space-y-5 lg:space-y-6 2xl:min-w-33.5">
              ...
              <div className="flex flex-col items-start gap-2 sm:gap-3 lg:gap-4">
                <Link href="/" className="footer-links">Book Tickets</Link>
                <Link href="/my-tickets" className="footer-links">My Tickets</Link>
                <Link href="/track-bus" className="footer-links">Track Bus</Link>
        ...
        <div className="flex flex-col-reverse items-center justify-between gap-5 py-7.5 md:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 sm:flex-nowrap">
            <Link href="/terms-conditions" className="footer-links">Terms & conditions</Link>
            <Link href="/privacy-policy" className="footer-links">Privacy Policy</Link>
            <Link href="/refund-policy" className="footer-links">Refund Policy</Link>
          </div>
        </div>
      </div>
    </footer>
